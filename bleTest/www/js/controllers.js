...
.controller('BLECtrl', function($scope, BLE) {
  ...
  //     $scope.dList.push(JSON.stringify(device));
...
.controller('BLEDetailCtrl', function($scope, $stateParams, BLE) {
  BLE.connect($stateParams.deviceId).then(
      function(peripheral) {
          ...
          // console.log("deviceId : "+$stateParams.deviceId);
      },
      function(error){
  ...
  //   ble.read($stateParams.deviceId,uuid,chuuid,
  //     function(peripheral) {
  ...
  $scope.onWrite = function(set) {
    ...
    var str = '222.222.222.222';
    // var arr = new ArrayBuffer(str.length);
    // arr.write(str);

    // BLE.write($stateParams.deviceId,uuid,chuuid,d).then(
    //     function(peripheral){
    //       console.log(bytesToString(peripheral));
    //     },
    //     function(error){
